  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1c1c28] text-white p-4 relative">
      ...
      <div className="w-full max-w-md">
        <h1 className="text-3xl font-bold mb-6 text-center">Create a <span className="brand-text"><span>Generative Engineering</span><span className="js">.js</span></span> account</h1>
        <p className="text-sm text-gray-400 mb-8 text-center">
          Already have an account? <Link to="/login" className="text-yellow-500 hover:underline">Log in</Link>
        </p>
        <RegistrationForm />
        <div className="mt-8">
